...
export default function QuillPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-yellow-50 via-slate-100 to-lime-50 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-700 flex flex-col items-center py-8">
      ...
      <section className="w-full max-w-3xl mx-auto mt-8 bg-white/80 dark:bg-zinc-800/95 shadow-xl rounded-2xl px-8 py-10 flex flex-col gap-8 border border-zinc-100 dark:border-zinc-700">
        <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-lime-500 to-green-400 drop-shadow">
          Quill Editor
        </h1>
        <p className="text-sm text-zinc-600 dark:text-zinc-300">
          Simple and fast editor with modular architecture.
        </p>
