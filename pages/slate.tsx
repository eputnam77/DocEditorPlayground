...
export default function SlatePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-100 to-blue-50 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-700 flex flex-col items-center py-8">
      ...
      <section className="w-full max-w-3xl mx-auto mt-8 bg-white/80 dark:bg-zinc-800/95 shadow-xl rounded-2xl px-8 py-10 flex flex-col gap-8 border border-zinc-100 dark:border-zinc-700">
        <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-slate-500 to-indigo-500 drop-shadow">
          Slate Editor
        </h1>
        <p className="text-sm text-zinc-600 dark:text-zinc-300">
          Highly customizable editor using React and immutable data structures.
        </p>
